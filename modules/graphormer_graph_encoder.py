...
from examples.graph_diffusion.modules.multihead_attention import MultiheadAttention
from examples.graph_diffusion.modules.graphormer_layers import GraphNodeFeature, GraphAttnBias
from examples.graph_diffusion.modules.graphormer_graph_encoder_layer import GraphormerGraphEncoderLayer
...
class GraphormerGraphEncoder(nn.Module):
    ...
    def forward(
        ...
        if self.traceable:
            ...
            return inner_states, graph_rep # B*T, 80
